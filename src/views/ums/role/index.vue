    ...
    <div class="app-container">
        <el-card class="filter-container" shadow="never">
            <div>
                ...
                <el-button style="float:right;margin-right: 50px" @click="handleResetSearch()" size="small">重置</el-button>
            </div>
        ...
        <div class="table-container">
            <el-table ref="roleTable" :data="list" style="width: 100%" v-loading="listLoading" border>
                ...
                <el-table-column label="用户数" width="100" aalign="center">
                    <template slot-scope="scope">{{scope.row.adminCount}}</template>
                </el-table-column>
                <el-table-column label="添加时间" width="160" aalign="center">
                    <template slot-scope="scope">{{scope.row.createTime | formatDateTime}}</template>
                </el-table-column>
                <el-table-column label="是否启用" width="140" aalign="center">
        ...
        <div class="pagination-container">
            <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" layout="total, sizes, prev, pager, next, jumper"
                           :current-page.sync="listQuery.pageNum" :page-size="listQuery.pageSize" :page-sizes="[5,10,15]" :total="total"></el-pagination>
        </div>
        <el-dialog :title="isEdit?'编辑角色':'添加角色'" :visible.sync="dialogVisible" width="40%">
            <el-form :model="role" ref="roleForm" label-width="150px" size="small">
                ...
                <el-form-item label="描述">
                    <el-input v-model="role.description" type="textarea" style="width: 250px"></el-input>
                </el-form-item>
