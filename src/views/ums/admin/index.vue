    ...
    <div class="app-container">
            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
                    <el-form-item label="输入搜索：">
                        <el-input v-model="listQuery.keyword" class="input-width" placeholder="账户/姓名" clearable></el-input>
                    </el-form-item>
                </el-form>
            </div>
        </el-card>
            ...
            <el-table ref="adminTable" :data="list" style="width: 100%" v-loading="listLoading" border>
                ...
                <el-table-column label="是否启用" width="140" align="center">
                    <template slot-scope="scope">
                        <el-switch @change="handleStatusChange(scope.$index,scope.row)" :active-value="1" :inactive-value="0" v-model="scope.row.stetus"></el-switch>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="分配角色" :visible.sync="allocDialogVisible" width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="handleAllocDialogConfirm()" size="small">确定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
